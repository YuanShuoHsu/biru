...
interface OrderOrganizationSlugLayoutProps {
...
const OrderOrganizationSlugLayout = async ({
  children,
  params,
}: OrderOrganizationSlugLayoutProps) => {
...
export default OrderOrganizationSlugLayout;
