...
const OrderModeOrganizationSlugCheckout = ({
  ...
  // 每次 render 重算會讓下方的區間掃描永遠無法快取，只在有機會過期的時機推進
  ...
  // MUI 以 callback 的 identity 當快取鍵，每次 render 換新的會讓整個月曆重掃
  ...
  return (
    <FormBox onSubmit={onSubmit}>
      ...
      <Stack direction="row" justifyContent="space-between">
        ...
        {/* 不能因 pickupUnavailableReason 而 disable：now 只在送出被擋時推進，擋住送出等於讓過期的區間再也回不來 */}
        <Button
