...
export const menu: Menu[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        createdAt: new Date("2024-05-30T04:00:00"),
        description: {
          "zh-TW": "香甜焦糖與香醇濃縮完美結合。",
    ...
    items: [
      {
        ...
        createdAt: new Date("2024-04-18T10:15:00"),
        description: {
          "zh-TW": "清新茉莉花香與綠茶完美融合。",
      ...
      },
      {
        ...
        createdAt: new Date("2024-05-10T16:30:00"),
        description: {
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        createdAt: new Date("2024-06-05T14:30:00"),
        description: {
          "zh-TW": "抹茶與牛奶氣泡完美結合。",
    ...
    items: [
      {
        ...
        createdAt: new Date("2024-04-28T08:10:00"),
        description: {
          "zh-TW": "外酥內軟的法式可頌。",
    ...
    items: [
      {
        ...
        createdAt: new Date("2024-06-03T11:45:00"),
        description: {
