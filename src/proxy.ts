...
export const config = {
  matcher: [
    "/((?!api|_next/data|_next/static|_next/image|apple-icon.png|favicon.ico|icon\\.svg|manifest\\.webmanifest|opengraph-image\\.jpg|twitter-image\\.jpg|sitemap.xml|robots.txt|\\.well-known|images).*)",
  ],
};
